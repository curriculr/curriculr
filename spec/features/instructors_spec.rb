...
feature 'Instructors' do
  ...
  scenario 'can create assessment' do
    login_as(@instructor, :scope => :user)
    visit root_path
  ...
  scenario 'can edit assessment' do
  ...
  scenario 'can create a lecture in the unit' do
    login_as(@instructor, :scope => :user)
    visit root_path
  ...
  # scenario 'can edit a lecture in the unit' do
  #   login_as(@instructor, :scope => :user)
  #   visit root_path
  ...
  scenario 'can create an assessment in the unit' do
    login_as(@instructor, :scope => :user)
    visit root_path
  ...
  scenario 'can edit an assessment in the unit' do
  ...
  scenario 'can create a page in the unit' do
    login_as(@instructor, :scope => :user)
    visit root_path
  ...
  scenario 'can edit a page in the unit' do
    login_as(@instructor, :scope => :user)
    visit root_path
  ...
  # scenario 'can add a document in the unit' do
  #   login_as(@instructor, :scope => :user)
  #   visit root_path
